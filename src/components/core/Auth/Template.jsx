      ...
      {loading ? (
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col-reverse justify-between gap-y-12 py-12 md:flex-row md:gap-y-0 md:gap-x-12">
          <div className="mx-auto w-11/12 max-w-[450px] md:mx-0">
            <h1 className="text-[1.575rem] font-semibold leading-[2.375rem] text-richblack-500">
              {title} <span className="bg-gradient-to-br from-[#D97706] to-[#7C2D12] inline-block text-transparent bg-clip-text">{title2}</span>
            </h1>
            <p className="mt-4 text-[1.125rem] leading-[1.625rem] mb-3">
          ...
          <div className="relative mx-auto w-11/12 max-w-[450px] md:mx-0">
            ...
            <img
              ...
              height={504}
              loading="lazy"
              className="absolute -top-4 mt-10 right-4 z-10"
            />
          </div>
